...
st.markdown("<h4 style = 'margin: -30px; color: #87A922; text-align: center; font-family: cursive '>Built by James</h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html=True)

# Add an image
st.image('pngwing.com (3).png', caption = 'Built by James' )
